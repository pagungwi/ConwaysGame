...
__global__ 
void global_CreateImage(unsigned char *d_in, unsigned char *d_out, const int rows, const int cols, uchar4 * image){

}


__global__ 
void shared_CreateImage(unsigned char *d_in, unsigned char *d_out, const int rows, const int cols, uchar4 * image){

}


__global__ 
void global_Conways(unsigned char *d_in, unsigned char *d_out, const int rows, const int cols){

}

__global__ 
void shared_Conways(unsigned char *d_in, unsigned char *d_out, const int rows, const int cols){
